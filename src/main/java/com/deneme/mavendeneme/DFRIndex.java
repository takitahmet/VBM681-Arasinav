 ...
 * @version 2021-04-12
 */
public class DFRIndex {

    public static void main( String[] args ) {
        try {

            // change the following input and output paths to your local ones
            String pathCorpus = "C:\\Users\\Administrator\\eclipse-workspace\\VBM681-Ahmet Takıt\\example_corpus.gz";
            ...
            BasicModel basicModel = new BasicModelIn();
            AfterEffect afterEffect = new AfterEffectB();
            Normalization normalization = new NormalizationZ();
            
            
            config.setSimilarity( new DFRSimilarity(basicModel, afterEffect, normalization) );
